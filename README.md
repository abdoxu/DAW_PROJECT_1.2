...
7. **created a fork of the original repository in your GitHub account (y3ni twli 3andk copy fi github ta3k):**
    ...
    **Navigate to the Repository:**
    ...
    Go to the GitHub repository you want to fork. For example, if you want to fork the repository at [https://github.com/kh-aymen/DAW_PROJECT_1.2.git](https://github.com/kh-aymen/DAW_PROJECT_1.2.git)
